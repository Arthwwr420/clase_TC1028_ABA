...
#### Nota: Para evitar problemas con la biblioteca Pillow, se omitio por esta entrega

### API:
Se incorpora la libreria de Random, del API de python, especificamente random.randrange()
