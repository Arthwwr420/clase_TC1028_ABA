...
Esta version del programa vuelve a ser simulada después de haber tenido dificultades para
el desarrollo con la librería Pillow, la proxima versión planea volver a ser completamente funcional. 
Se han introducido opciones que permiten al usuario elegir la aleatoriedad de las imagenes e incluso un 
modo manual
"""
